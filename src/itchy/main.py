...
from itchy.dummy_nodes import find_node, RECOVERY_STRATEGIES, make_dummy_primary
import argparse
...
parser = Parser(skip_bad_tokens=False, skip_rules_on_fail={"primary": make_dummy_primary()})
    ...
    with open(file) as f:
        ...
        try:
            ...
            if isinstance(e, ParseError):
                ...
                print_ast(find_node(parser.deepest_partial.tree, "eventstat"))
